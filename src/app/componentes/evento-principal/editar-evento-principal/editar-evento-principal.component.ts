...
@Component({
  selector: 'app-editar-evento-principal',
  templateUrl: './editar-evento-principal.component.html',
  styleUrls: ['./editar-evento-principal.component.css']
})

export class EditarEventoPrincipalComponent implements OnInit {
